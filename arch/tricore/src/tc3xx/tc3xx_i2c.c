/****************************************************************************
 * arch/tricore/src/tc3xx/tc3xx_i2c.c
 *
...
#include "hardware/tc3xx_i2c.h"

#ifdef CONFIG_TC3XX_I2C0
static const struct tricore_i2c_config_s g_tc3xx_i2c0_config =
{
  .base          = TC3XX_I2C0_BASE,
  .frequency     = CONFIG_TC3XX_I2C0_FREQUENCY,
  .clk_freq      = CONFIG_TC3XX_I2C_CLOCK_FREQ,
  .bus           = 0,
  .pisel         = CONFIG_TC3XX_I2C0_PISEL,
  .clc_offset    = TC3XX_I2C_CLC_OFFSET,
  .gpctl_offset  = TC3XX_I2C_GPCTL_OFFSET,
};

static struct tricore_i2c_priv_s g_tc3xx_i2c0_priv =
{
  .ops    = &g_tricore_i2c_ops,
  .config = &g_tc3xx_i2c0_config,
  .lock   = NXMUTEX_INITIALIZER,
};
#endif

#ifdef CONFIG_TC3XX_I2C1
static const struct tricore_i2c_config_s g_tc3xx_i2c1_config =
{
  .base          = TC3XX_I2C1_BASE,
  .frequency     = CONFIG_TC3XX_I2C1_FREQUENCY,
  .clk_freq      = CONFIG_TC3XX_I2C_CLOCK_FREQ,
  .bus           = 1,
  .pisel         = CONFIG_TC3XX_I2C1_PISEL,
  .clc_offset    = TC3XX_I2C_CLC_OFFSET,
  .gpctl_offset  = TC3XX_I2C_GPCTL_OFFSET,
};

static struct tricore_i2c_priv_s g_tc3xx_i2c1_priv =
{
  .ops    = &g_tricore_i2c_ops,
  .config = &g_tc3xx_i2c1_config,
  .lock   = NXMUTEX_INITIALIZER,
};
#endif
...
static int tc3xx_i2c_wait_clk_enable(struct tricore_i2c_priv_s *priv,
...
int tricore_i2c_hw_init(struct tricore_i2c_priv_s *priv)
{
  ...
  ret = tc3xx_i2c_wait_clk_enable(priv, cfg->clc_offset,
                                  I2C_CLK_TIMEOUT_US);
  if (ret < 0)
    {
  ...
  ret = tc3xx_i2c_wait_clk_enable(priv, TRICORE_I2C_CLC1_OFFSET,
                                  I2C_CLK_TIMEOUT_US);
  if (ret < 0)
    {
...
FAR struct i2c_master_s *tc3xx_i2cbus_initialize(int port)
{
...
#ifdef CONFIG_TC3XX_I2C0
      case 0:
        priv = &g_tc3xx_i2c0_priv;
        break;
#endif
#ifdef CONFIG_TC3XX_I2C1
      case 1:
        priv = &g_tc3xx_i2c1_priv;
        break;
#endif
      default:
        return NULL;
